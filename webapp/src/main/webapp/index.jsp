<form action="action_page.php">
  <div class="container">
    <h1>New user Register for DevOps Learning by Arjun & Sandip!!!</h1>
    <p>Please fill in this form to create an account.</p>
    <hr>
     
    <label for="Name"><b>Enter your Name</b></label>
    <input type="text" placeholder="Enter Full Name Here" name="Name" id="Name" required>
    <br>
    
    <label for="mobile"><b>Enter mobile</b></label>
    <input type="text" placeholder="Enter mobile number Here" name="mobile" id="mobile" required>
    <br>
